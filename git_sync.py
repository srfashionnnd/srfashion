...
if result.returncode == 0:
    ...
    "nothing to commit" in (result.stdout + result.stderr).lower()
    or "working tree clean" in (result.stdout + result.stderr).lower()
):
...
if (
    "Your branch is up to date with 'origin/main'" in status_output
    or "nothing to commit, working tree clean" in status_output
):
    print("========================================")
    print("Git Sync Finished Successfully")
    print("========================================")
